...
void Application::getInput(vector<string> getType) {
  ...
  if (getType[0].compare("create") == 0) {
    // cout << "Enter type of input you want to create: \"Random = 0\", \"Many_Duplicate = 1\", \"Nearly_Sorted = 2\", \"Sorted = 3\", \"Reverse_Sorted = 4\"" << endl;
    // int type;
    // cin >> type;
    ...
    // if (type < Random || type > Reverse_Sorted || size < 1) {
    //   return ;
    // } 
    // else {
...
void Application::resultMesaure(SortAlgorithm* algor) {
        ...
        algorithm_result.time = static_cast<double>(us.count()) ;
    }

// print result: sorted array, time, .... to screen
void Application::printResult(SortAlgorithm* algor) {
  cout << "Algorithm " << algor->name_ << endl;
  cout << "Time to sort this array is: " << fixed << algorithm_result.time << "seconds" << endl;
...
void Application::resultToFile(SortAlgorithm* algor) {
  ...
  result << "Time to sort this array is: " << fixed << algorithm_result.time / 10000000 << " miliseconds" << endl;
  ...
  result << "........................................................" << endl;
  result.close();
  cout << "Wrote result to file " << endl;
} 
...
void Application::run(vector<string> input, vector<string> algorName) {
    ...
    for (auto &name : algorName) {
      ...
      setAlgorithm(nameToAlgorithm(name));
      cout << "Sorting ..............." << endl;
    ...
    //   setAlgorithm(nameToAlgorithm(algorithmName));

    //   cout << "Sorting ..............." << endl;
    //   cout << algorithm->name_ << endl;
    //   resultMesaure();
    //   cout << "Array is sorted" << endl;
    //   stableCheck();
    //   // cout << "Enter \"Screen\" to print result to screen, \"File\" to write result to text file" << endl;
    ...
    //   for (int i = 0; i < NUMBER_SORT_ALGORITHM; i++) {
    //     FileToArr();
    //     setAlgorithm(nameToAlgorithm(SortType[i]));
